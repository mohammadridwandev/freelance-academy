        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="text-2xl lg:text-start  pb-3 font-bold bg-linear-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent  lg:text-4xl">
              <h1>
                Empowering the Next Generation <span className="bg-linear-to-r from-red-500 to-blue-600 bg-clip-text text-transparent"> of Digital Professionals
                </span>{" "}
              </h1>
            ...
            <p className="text-base text-gray-500 leading-relaxed mb-6">
              ...
              between education and industry with project-based training in Web
